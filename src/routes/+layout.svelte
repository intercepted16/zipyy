<script lang="ts">
  ...
  import { entries, userData } from "./store.js";
  ...
  import { AppShell, popup, storePopup } from "@skeletonlabs/skeleton";
  ...
  // if (splitHashes($page.url.hash).access_token) {
  //   let currentURL = $page.url.href.replace(/#.*$/, "");
  ...
  onMount(() => {
    ...
    // modalStore.trigger(verifyEmailModal);
  });
  ...
  const verifyEmailModal: ModalSettings = {
    type: "alert",
    title: "Please verify your account",
    body: "Follow the link in your inbox to verify your account",
    buttonTextCancel: "Okay, got it!",
  };
  ...
  //     modalStore.trigger({
  //       type: "component",
  //       component: `${data.modal}Modal`,
  //     });
  //     console.log("After", $modalStore);

  //     if (browser) {
  //       await fetch("/delete-cookie", {
  //         method: "POST",
  //         body: JSON.stringify({ key: "modal" }),
  //       });
  //     }
  //   }
  // })();
...
<!-- <Header /> -->
<Drawer class="lg:hidden"><Navigation {data} /></Drawer>
<AppShell slot>
  <svelte:fragment slot="header">
    <AppBar
      slotDefault="place-self-center"
      slotTrail="flex items-center space-x-2"
      slotLead="flex items-center justify-between flex-none"
      shadow="shadow-xl"
    >
      ...
      <svelte:fragment slot="lead">
        <div class="flex items-center space-x-4">
          <button
            class="block btn-icon btn-icon-sm sm:hidden"
            on:click={drawerOpen}><i class="text-2xl bi bi-list"></i></button
          >
          <a
  ...
  <div slot="pageFooter" class:hidden={$page.url.pathname == "/signup"}>
    <Footer />
  </div>
</AppShell>
