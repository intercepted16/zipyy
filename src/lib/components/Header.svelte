    ...
    >
      <div class="flex-1 w-full md:w-auto md:flex-none">
        <button
          type="button"
          tabindex="0"
          class="relative inline-flex items-center justify-start w-full px-4 py-2 text-sm font-medium transition-colors bg-transparent border rounded-md shadow-sm whitespace-nowrap focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border-input hover:bg-accent hover:text-accent-foreground h-9 text-muted-foreground sm:pr-12 md:w-40 lg:w-64"
          data-button-root=""
